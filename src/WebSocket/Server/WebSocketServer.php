...
class WebSocketServer {
	 ...
	 */
	public function __construct(WebSocketServerInterface $app, ServerInterface $socket, LoopInterface $loop = null) {
	 ...
	 * @return IoServer
	 */
	public static function factory(WebSocketServerInterface $component, $address = '127.0.0.1', $port = 8080) {
	...
	public function handleConnect($conn) {
		$conn->decor = new ServerConnection($conn);
